...
var CommentConnectService = /** @class */ (function () {
    function CommentConnectService(http) {
        this.http = http;
        this.postUrl = 'http://localhost:8080/comments/all';
    }
    CommentConnectService.prototype.findAll = function () {
        return this.http.get(this.postUrl);
    };
    CommentConnectService.prototype.save = function (comment) {
        return this.http.post(this.postUrl, comment);
    };
    CommentConnectService.ctorParameters = function () { return [
...
var CommentsListComponent = /** @class */ (function () {
    ...
    CommentsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.commentService.findAll().subscribe(function (data) {
            _this.comments = data;
        });
    };
